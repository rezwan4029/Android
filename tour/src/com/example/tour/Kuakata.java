...
public class Kuakata extends Activity {
	TextView Txt1;
	Button btn;
	double lat = 22.8087816 ;
	double lon = 89.24671910000006 ;
	String place = "Kuakata";
	String res = "";
	
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.kuakata_page);
		...
		btn.setOnClickListener(new OnClickListener() {			
			public void onClick(View v) {
				Intent myInt = new Intent(Kuakata.this, NavigationActivity.class);
